...
<br>
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>3D Modelling PCs</strong></h1>
        <p style="font-size: 15px;">Our 3D Modelling PCs are focussed on being GPU and Memory heavy and designed to handle three-dimensional workloads <br>with ease, every second of the way. Render complicated 3D scenes using your favourite modelling, FX or development <br>software.</p>
        </div> 
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-4">
      ...
      <div class="col">
        <div class="card h-100">
          <img src="assets/3D Modelling PCs _ Direct Computers/1 (1).jpg" class="card-img-top" alt="#">
          <div class="card-body text-center" style="background-color:rgb(253 239 228)">
            ...
            <p style="font-size: 14px;">Intel® Core™ i9-12900K - Nvidia RTX 4080 16GB - 64GB RAM 3600MHz - 2TB M.2 Gen4 - WiFi</p>
            <div class="mb-2">
      ...
      <div class="col">
        <div class="card h-100">
          <img src="assets/3D Modelling PCs _ Direct Computers/1 (2).jpg" class="card-img-top" alt="#">
          <div class="card-body text-center" style="background-color:rgb(253 239 228)">
			<!--
            <h5 class="card-title text-uppercase" style="color: #eb0905;">{{ $product->sale_label ?? 'SALE' }}</h5>
			-->
            ...
            <p style="font-size: 14px;">Ryzen 5 5600 - RTX 3050 8GB - 16GB RAM 3600MHz - 500GB M.2 Gen4 - WiFi - Windows 10 Pro</p>
            <div class="mb-2">
              <i class="fa fa-star text-warning"></i>
              <i class="fa fa-star text-warning"></i>
              <i class="fa fa-star text-warning"></i>
      ...
      <div class="col">
        <div class="card h-100">
          <img src="assets/3D Modelling PCs _ Direct Computers/1 (3).jpg" class="card-img-top" alt="#">
          <div class="card-body text-center" style="background-color:rgb(253 239 228)">
			<!--
            <h5 class="card-title text-uppercase" style="color: #eb0905;">{{ $product->sale_label ?? 'SALE' }}</h5>
			-->
            ...
            <p style="font-size: 14px;">Ryzen 5 5600X - RTX 3070 8GB - 16GB RAM 3600MHz - 1TB M.2 Gen4 - WiFi Windows 10 Pro</p>
            <div class="mb-2">
              <i class="fa fa-star text-warning"></i>
              <i class="fa fa-star text-warning"></i>
              <i class="fa fa-star text-warning"></i>
      ...
      <div class="col">
        <div class="card h-100">
          <img src="assets/3D Modelling PCs _ Direct Computers/1 (4).jpg" class="card-img-top" alt="#">
          <div class="card-body text-center" style="background-color:rgb(253 239 228)">
			<!--
            <h5 class="card-title text-uppercase" style="color: #eb0905;">{{ $product->sale_label ?? 'SALE' }}</h5>
			-->
            ...
            <p style="font-size: 14px;">Intel® Core™ i5-12600K - RTX 3070 Ti 8GB - 16GB RAM 3200MHz -1TB M.2 Gen4 - WiFi</p>
            <div class="mb-2">
              <i class="fa fa-star text-warning"></i>
              <i class="fa fa-star text-warning"></i>
              <i class="fa fa-star text-warning"></i>
