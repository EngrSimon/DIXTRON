...
<!---------------------->
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Enterprise Drives</strong></h1>
        <p style="font-size: 15px;">Optimize your enterprise storage infrastructure with our SSD and HDD solutions. Designed for reliability and performance, <br>our enterprise-grade drives offer high-capacity storage and fast data access. Explore our range of SSD and HDD options, <br>featuring robust construction and advanced features to meet the demands of enterprise environments. Elevate your data <br>storage capabilities with our dependable SSD and HDD solutions.</p>
        </div><hr>
