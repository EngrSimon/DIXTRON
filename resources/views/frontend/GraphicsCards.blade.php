...
<div class="promo-section">
  ...
  <!------------------------->
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Graphics Cards</strong></h1>
        <p style="font-size: 15px;">Take advantage of amazing deals on our Graphics cards range with the latest Nvidia RTX 3000 series and Nvidia RTX 4000 <br>series GPUs and AMD RX 6000 series graphics cards. We supply a range of AMD, Nvidia and Intel Graphics Cards with <br>multiple brands available. Shop online and get it delivered or order & collect in store.</p>
        </div>

        
        <div class="box-cat">
            <div class="box-container">
          <a href="Nvidia Graphics Cards.html"><div class="box">Nvidia Graphics Cards</a></div>
          <a href="AMD Graphics Cards.html"><div class="box">AMD Graphics Cards</div></a> 
          <a href="Intel Graphics Cards.html"><div class="box">Intel Graphics Cards</div></a> 
          </div> 
        </div><hr>
