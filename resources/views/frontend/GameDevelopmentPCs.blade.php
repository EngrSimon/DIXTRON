...
<br>
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Game Development PCs</strong></h1>
        <p style="font-size: 15px;">Our Games Development Workstations are built to bring you the optimal hardware where you need it most. Developing <br>games requires a whole host of different software and hardware, and they all need to work seamlessly together. We work <br>hard with software, hardware and games developers to deliver the best computers for Games Development</p>
        </div> 
