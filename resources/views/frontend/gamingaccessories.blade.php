...
<br>
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Gaming Accessories</strong></h1> 
        <p style="font-size: 15px;">Level up your gaming experience with our range of gaming accessories. From ergonomic gaming chairs to precision gaming <br>mice and immersive headsets, we offer everything you need to dominate the battlefield. Explore our selection of gaming <br>accessories designed for comfort, performance, and style. Elevate your setup and stay ahead of the competition with our <br> top-of-the-line gaming gear.</p>
        </div> 

<div class="box-cat">
        <div class="box-container">
      <a href="{{route('RacingSimulators')}}"><div class="box">Racing Simulators</a></div>
      <a href="{{route('GamingChairs')}}"><div class="box">Gaming Chairs</div></a> 
      <a href="{{route('GamingDesks')}}"><div class="box">Gaming Desks</div></a> 
      </div> 
    </div><hr>
