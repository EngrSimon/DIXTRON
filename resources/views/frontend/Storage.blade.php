...
<br>
    ...
    <div class="next-text">
        ...
        <div class="box-cat">
          ...
          <a href="{{route('SolidStateDrives')}}"><div class="box">Solid State Drives</div></a>
          <a href="{{route('M2NVMESSD')}}"><div class="box">M.2/NVME SSD</div></a> 
          <a href="{{route('TwoFiveSsd')}}"><div class="box">2.5" SSD</div></a> 
          <a href="{{route('HardDrivesInternalHDDs')}}"><div class="box">Hard Drives-Internal(HDDs)</a></div>
          <a href="{{route('HardDrivesExternalHDDs')}}"><div class="box">Hard Drives - External (HDDs)</div></a> 
          <a href="{{route('EnterpriseDrives')}}"><div class="box">Enterprise Drives</div></a> 
          </div> 
        </div><hr>
