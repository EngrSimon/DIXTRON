...
<!--------------->
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Video Editing PCs</strong></h1>
        <p style="font-size: 15px;">Experience the joy of a powerful 4K editing workstation with our latest Video Editing PCs. Huge, fast storage allows <br>for smooth, editing and file manipulation, whilst the powerful processors and graphics cards provide stutter-free, full-resolution <br>playback.</p>
        </div> 
