...
<!--------->
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>AMD Ryzen 7 PCs</strong></h1>
        <p style="font-size: 15px;">Experience exceptional performance with our AMD Ryzen 7 PCs. Powered by AMD's high-performance processors, our <br> desktops deliver seamless multitasking and impressive speed. Explore our range of Ryzen 7 PCs designed to meet the <br> demands of modern computing. Whether you're a creative professional, gamer, or multitasking enthusiast, unlock new levels of <br>productivity and efficiency with our AMD Ryzen 7 PCs.</p>
        </div> 
      ...
      <div class="col">
        <div class="card h-100">
          ...
          <div class="card-body text-center" style="background-color:rgb(253 239 228)">
            ...
            <p style="font-size: 14px;">Ryzen 7 5700X3D, 16GB DDR4, RTX 4060 Ti 16GB, 1TB SSD, 32" 165Hz Monitor Gaming PC</p>
            <div class="mb-2">
              <i class="fa fa-star text-warning"></i>
              <i class="fa fa-star text-warning"></i>
              <i class="fa fa-star text-warning"></i>
