...
<!-----promo section---->
    ...
    <section class="brand-section">
        <div class="brand-content">
            ...
            <p>WD is a computer hard disk drive manufacturer and data storage company. It is one of the largest computer hard disk drive manufacturers, along with producing SSDs and flash memory devices. Their high-quality range of SSDs and mechanical drives can be found at Direct Computers.</p>
    </section>
