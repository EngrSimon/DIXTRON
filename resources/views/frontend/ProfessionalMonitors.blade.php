...
<!-------------------->
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Professional Monitors</strong></h1><!-----
        <p style="font-size: 15px;">Boost every frame with our gaming monitors for desktop gaming from ASUS and ASRock. We offer 4K monitors, 1440p <br>monitors, 165Hz monitors. G-SYNC and FreeSync screens. Finance available.</p>
        </div>-------> <hr>
