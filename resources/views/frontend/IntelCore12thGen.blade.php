...
<br>
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Intel Core 12th Gen Custom PCs</strong></h1>
        <p style="font-size: 15px;">Direct Computers provides a range of the latest Intel 12th Gen Gaming PCs to suit any budget. All PCs can be upgraded <br> with the latest components, including peripherals, storage upgrades, graphics cards, memory and more. 0% Finance <br> available, 1 Year Warranty and Free UK Delivery included!</p>
        </div><hr>
