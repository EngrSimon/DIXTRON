...
<br>
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Microsoft Windows Lincense</strong></h1> 
        <p style="font-size: 15px;">Elevate your digital experience with a Microsoft Windows License. Gain access to a secure and efficient operating system <br>trusted by millions worldwide. Enjoy seamless integration, enhanced performance, and robust security features. Explore <br>licensing options to unlock the full potential of your device with Microsoft Windows.</p>
        </div> <hr>
