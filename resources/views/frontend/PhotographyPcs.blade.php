...
<!------------>
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Photography PCs</strong></h1>
        <p style="font-size: 15px;">Photography systems designed to excel in all photography tasks. Fast storage and processing power for managing large <br>libraries, smooth image manipulation and fast exports make your workflow faster and easier to manage.</p>
        </div> 
