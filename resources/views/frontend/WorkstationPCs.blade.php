...
<br>
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Workstation PCs</strong></h1>
        <p style="font-size: 15px;">Powerful PCs designed for demanding tasks and uses. We have specific designs for everything from Photography <br> editing workstations through to rendering machines designed to improve your workflow and reduce down-time. </p>
        </div> 
<div class="box-cat">
