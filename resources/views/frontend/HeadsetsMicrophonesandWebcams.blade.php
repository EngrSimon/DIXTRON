...
<br>
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Headsets, Microphones & Webcams</strong></h1> 
        <p style="font-size: 15px;">Take advantage of amazing deals on our Headsets, Microphones and Webcams range here at Dextron Computers.</p>
        </div> 

<div class="box-cat">
        <div class="box-container">
      <a href="{{route('Headsets')}}"><div class="box">Headsets</a></div>
      <a href="{{route('Microphones')}}"><div class="box">Microphones</div></a> 
      <a href="{{route('Speakers')}}"><div class="box">Speakers</div></a>
      <a href="{{route('Webcams')}}"><div class="box">Webcams</div></a>
      </div> 
    </div><hr>
