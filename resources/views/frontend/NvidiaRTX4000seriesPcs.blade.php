...
<div class="next-text">
<h1 style="font-size: 40px;"> <strong>Nvidia RTX 4000 Series PCs</strong></h1>
<p style="font-size: 15px;">Custom PCs designed using the latest Turing Architecture with RTX 4000 combines the NVIDIA Turing GPU architecture <br>with the latest memory and display technologies, to deliver the best performance and features in a single-slot PCI-e form <br>  factor.</p>
<h1 style="font-size: 18px;">Build your Own Custom Pc with us today <span style="text-decoration: underline;"><a href="">CLICK HERE</a></span></h1>
</div> <hr>
