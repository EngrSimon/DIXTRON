...
<br>
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Intel Proccessors</strong></h1>
        <p style="font-size: 15px;">Whether you are building an entirely new PC or upgrading an existing one, Intel processors provide the performance boost <br>you are looking for. Whatever your budget, there is an Intel Core processor for you.</p>
        </div><hr>
