...
<!-------------------->
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Racing Simulators</strong></h1> 
        <p style="font-size: 15px;">Discover top-notch racing simulators featuring components from Asetek, Heusinkveld, Logitech, MOZA Racing, Next Level <br>Racing, and Thrustmaster. Explore wheels, pedals, seats, and more to create the ultimate racing experience.</p> 
        </div> <hr>
