...
<br> 
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Intel Core i3 PCs</strong></h1>
        <p style="font-size: 15px;">Power through everyday tasks with our Intel Core i3 PCs. Featuring Intel's reliable processors, our desktops offer smooth <br> performance for your essential computing needs. Explore our range of Core i3 PCs designed to handle everyday tasks <br> with ease. Whether you're browsing the web, streaming media, or working on documents, find the perfect Intel Core i3 <br> PC to suit your home or office setup.</p>
        </div><hr>
