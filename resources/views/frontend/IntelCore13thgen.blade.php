...
<br>
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Intel Core 13th Gen Custom PCs</strong></h1>
        <p style="font-size: 15px;">High performance CPUs with the latest Intel technologies - The Intel Core 13th Generation, Purchase or configure <br> a Custom PC including the latest technologies available.</p>
