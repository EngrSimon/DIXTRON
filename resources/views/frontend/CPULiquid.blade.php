...
<!----------------------->
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>CPU Liquid Coolers</strong></h1>
        <p style="font-size: 15px;">Elevate your CPU cooling performance with our liquid coolers. Engineered for efficiency and reliability, our CPU liquid <br>coolers offer superior thermal management for high-performance systems. Explore our range of liquid coolers, featuring <br>advanced designs and customizable options to suit your build. Keep your CPU running at optimal temperatures and unlock <br> its full potential with our top-of-the-line liquid cooling solutions.</p>
        </div><hr>
