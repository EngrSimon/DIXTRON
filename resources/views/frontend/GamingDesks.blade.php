...
<!-------------->
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Gaming Desks</strong></h1> 
        <p style="font-size: 15px;">Upgrade your gaming setup with top-tier gaming desks from Nitro Concepts and ThunderX3. Discover ergonomic, stylish,<br>and durable desks designed for ultimate gaming comfort and performance.</p> 
        </div> <hr>
