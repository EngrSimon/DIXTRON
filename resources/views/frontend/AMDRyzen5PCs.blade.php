...
<br>
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>AMD Ryzen 5 PCs</strong></h1>
        <p style="font-size: 15px;">Elevate your computing experience with our AMD Ryzen 5 PCs. Featuring powerful AMD processors, our desktops deliver <br> reliable performance for everyday tasks and beyond. Explore our range of Ryzen 5 PCs designed to offer a balance of <br> efficiency and affordability. Whether you're working, gaming, or streaming, discover the perfect Ryzen 5 PC to meet your <br>needs and elevate your digital experience.</p>
        </div> 
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-4">
      ...
      <div class="col">
        <div class="card h-100">
          <img src="assets/AMD Ryzen 5 PCs _ Direct Computers/1 (1).jpg" class="card-img-top" alt="#">
          <div class="card-body text-center" style="background-color:rgb(253 239 228)">
            ...
            <p style="font-size: 14px;">Sentinel - Ryzen 5 7600X, 16GB DDR5, RX 7700 XT 12GB, 500GB SSD, AMD Gaming PC</p>
            <div class="mb-2">
      ...
      <div class="col">
        <div class="card h-100">
          <img src="assets/AMD Ryzen 5 PCs _ Direct Computers/1 (2).jpg" class="card-img-top" alt="#">
          <div class="card-body text-center" style="background-color:rgb(253 239 228)">
			<!--
            <h5 class="card-title text-uppercase" style="color: #eb0905;">{{ $product->sale_label ?? 'SALE' }}</h5>
			-->
            ...
            <p style="font-size: 14px;">Specter - Ryzen 5 8500G, 16GB DDR5, Radeon 740, 500GB SSD, AMD Gaming PC</p>
            <div class="mb-2">
              <i class="fa fa-star text-warning"></i>
              <i class="fa fa-star text-warning"></i>
              <i class="fa fa-star text-warning"></i>
      ...
      <div class="col">
        <div class="card h-100">
          <img src="assets/AMD Ryzen 5 PCs _ Direct Computers/1 (3).jpg" class="card-img-top" alt="#">
          <div class="card-body text-center" style="background-color:rgb(253 239 228)">
			<!--
            <h5 class="card-title text-uppercase" style="color: #eb0905;">{{ $product->sale_label ?? 'SALE' }}</h5>
			-->
      ...
      <div class="col">
        <div class="card h-100">
          <img src="assets/AMD Ryzen 5 PCs _ Direct Computers/1 (5).jpg" class="card-img-top" alt="#">
          <div class="card-body text-center" style="background-color:rgb(253 239 228)">
			<!--
            <h5 class="card-title text-uppercase" style="color: #eb0905;">{{ $product->sale_label ?? 'SALE' }}</h5>
			-->
            ...
            <p style="font-size: 14px;">DC r5 Home PC DC r5 Home PC DC r5 Home PC DC r5 Home PC DC r5 Home PC</p>
            <div class="mb-2">
              <i class="fa fa-star text-warning"></i>
              <i class="fa fa-star text-warning"></i>
              <i class="fa fa-star text-warning"></i>
