...
<!------------------->
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Routers/Mesh Systems & Switches</strong></h1> 
        <p style="font-size: 15px;">Our range of Routers & Switches will give you a soultion to your networking needs whether that be at home or at the <br>office. Top brands including Cisco, Draytek and more.</p>
        </div> 

<div class="box-cat">
        <div class="box-container">
      <a href="Routers and Mesh Systems.html"><div class="box">Routers/Mesh Systems</a></div>
      <a href="Network Switches.html"><div class="box">Network Switches</div></a> 
      <a href="Wireless Access.html"><div class="box">Wireless Access</div></a> 
      </div> 
    </div><hr>
