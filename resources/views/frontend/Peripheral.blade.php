...
<!----------------->
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Peripherals</strong></h1>
        <p style="font-size: 15px;">Enhance your computing experience with our range of computer peripherals. From ergonomic keyboards to precision mice <br>and high-quality headphones, we offer a wide selection of peripherals to complement your setup. Explore our range <br>and discover the perfect peripherals to improve your productivity and comfort while working or gaming.</p>
        </div> 

<div class="box-cat">
        <div class="box-container">
      <a href="Monitors.html"><div class="box">Monitors</a></div>
      <a href="Mouse and Keyboard.html"><div class="box">Mouse & Keyboards</div></a> 
      <a href="Headsets microphones and webcams.html"><div class="box">Headsets, Microphones & Webcams</div></a>
      <a href="Printing.html"><div class="box">Printing</div></a>
      </div> 
    </div><hr>
