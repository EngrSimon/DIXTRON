...
<br>
    ...
    <section class="brand-section">
        <div class="brand-content">
            <h1>AMD</h1>
            <p>View our range of AMD products that redefine performance, efficiency, and innovation in computing. As a premier retailer of AMD CPUs, Graphics Cards, and more, we pride ourselves on providing enthusiasts, gamers, and professionals with the tools they need to unlock their full potential.</p>
            <p class="short-text">
