...
<!----------------------->
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Thermal Paste</strong></h1>
        <p style="font-size: 15px;">Optimize heat transfer and ensure efficient cooling with our premium thermal paste. Designed for high-performance <br>systems, our thermal paste offers reliable thermal conductivity for CPUs and GPUs. Explore our range of thermal paste <br>solutions, featuring easy application and long-lasting performance. Keep your components running cool and stable with our <br>trusted thermal paste.</p>
        </div><hr>
