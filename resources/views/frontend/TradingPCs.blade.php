...
<br>
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Trading PCs</strong></h1>
        <p style="font-size: 15px;">Our Trading PCs allow for seamless, reliable trading with multi-screen outputs for constant whole-market monitoring. High-grade <br>components are used to increase the speed and reliability of your operations. </p>
        </div> 
