...
<!---------->
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Liquid Cooling Radiators</strong></h1>
        <p style="font-size: 15px;">Discover all the liquid cooling radiators we have to offer as an essential component for your water cooling system. Featuring <br>top manufacturers like Alphacool, Barrow, Bitspower, CORSAIR, DEMCiflex, EK Water Blocks, Hardware Labs, Magicool, and <br>XSPC, we offer a variety of radiator designs in different sizes, some equipped with fans and noise reduction features. <br> <br>

            Before placing your order, ensure your components are compatible and verify that you have adequate space in your case <br>for your entire setup.</p>
        </div><hr>
