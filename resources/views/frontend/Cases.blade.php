...
<!----------------------------->
 ...
 <br>
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Cases</strong></h1>
        <p style="font-size: 15px;">Protect and showcase your build with our selection of PC cases. Designed for style and performance, our cases offer <br>optimal airflow and cable management for a clean and efficient build. Explore our range of PC cases, featuring sleek designs <br>and customizable options to suit your needs. Elevate your PC build with a case that reflects your style and ensures optimal <br> performance.</p>
        </div> <hr>
