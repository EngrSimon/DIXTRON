...
<br>
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Printing</strong></h1> <!------
...
<div class="box-cat">
      ...
      <a href="{{route('PrinterInksAndCartridges')}}"><div class="box">Printer Inks & Cartridges</a></div>
      <a href="{{route('PrintersAndCopiers')}}"><div class="box">Printers & Copiers</div></a> 
      </div> 
    </div><hr>
