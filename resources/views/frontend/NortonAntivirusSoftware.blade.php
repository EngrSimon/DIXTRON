...
<!-------------------------->
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Norton Antivirus Software</strong></h1> 
        <p style="font-size: 15px;">Secure your digital world with Norton Antivirus Software. Protect your devices from online threats with industry-leading <br>security features. Safeguard your data, identity, and privacy with Norton's advanced protection. Explore Norton's range of <br>antivirus solutions for comprehensive defense against cyber threats.</p>
        </div> ><hr>
