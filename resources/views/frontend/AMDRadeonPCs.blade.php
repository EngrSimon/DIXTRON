...
<div class="next-text">
<h1 style="font-size: 40px;"> <strong>AMD Radeon PCs</strong></h1>
<p style="font-size: 15px;">Elevate your gaming experience with our AMD Radeon PCs. Featuring powerful AMD Radeon graphics, our desktops deliver <br>stunning visuals and smooth performance for gaming and multimedia tasks. Explore our range of Radeon PCs designed to <br>offer exceptional gaming experiences at every level. Whether you're a casual gamer or a hardcore enthusiast, immerse <br>yourself in high-quality graphics and seamless gameplay with our AMD Radeon PCs.</p>
</div> <hr>


<div class="box-cat">
    <div class="box-container">
  <a href="{{route('AMDRadeonRX7000SeriesPCs')}}"><div class="box">AMD Radeon RX 7000 Series PCs</a></div>
  </div> 
</div><hr>
