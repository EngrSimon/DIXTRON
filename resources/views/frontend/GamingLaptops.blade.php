...
<!---------------------------->
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Gaming Laptops</strong></h1>
        <p style="font-size: 15px;">Experience gaming like never before with our powerful gaming laptops. Featuring high-refresh rate displays and powerful <br>graphics, our laptops are built for epic gaming adventures. Choose from a range of sleek and portable models to unleash <br>your gaming potential.</p>
        </div> <hr>
