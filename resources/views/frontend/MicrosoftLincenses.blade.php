...
<!-------------->
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Microsoft Lincenses</strong></h1> 
        <p style="font-size: 15px;">Unlock the full potential of your digital workspace with Microsoft Licenses. Access essential productivity tools, cloud <br>services, and security features tailored to your business needs. Explore flexible licensing options for seamless integration <br> across devices and platforms. Empower your team with Microsoft's trusted suite of applications and services.</p>
        </div> 

<div class="box-cat">
        <div class="box-container">
      <a href="Microsoft Office Lincense.html"><div class="box">Microsoft Office Lincense</a></div>
      <a href="Microsoft Windows Lincense.html"><div class="box">Microsoft Windows Lincense</div></a> 
      </div> 
    </div><hr>
