...
<!----------------------------->
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Custom Built Desktop Gaming PCs</strong></h1>
        <p style="font-size: 15px;">Immerse yourself in the world of professional gaming with our exclusive Custom Gaming PC collection. Expertly crafted, our <br> Custom Built Gaming PCs showcase top-of-the-line components from Nvidia, AMD, Radeon, and Intel. Built on renowned <br> motherboards like ASUS ROG Strix and MSI Gaming, housed in sleek cases from Corsair and NZXT, and cooled with premium<br>solutions from Cooler Master and Noctua, our rigs are a testament to quality. Whether you're a streamer, content creator, or <br> professional gamer, explore a variety of options including Gaming PC Bundles, Streaming PCs, Workstation PCs, and Production <br> PCs tailored to your needs. Personalize your gaming setup effortlessly using our user-friendly configurator, supported by flexible finance <br> choices, a solid 3-year warranty, and free UK delivery. Each PC comes with a FREE copy of Windows 10 or 11 Pro. </p>
        </div> <br>
