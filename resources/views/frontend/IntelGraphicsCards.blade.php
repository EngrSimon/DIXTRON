...
<br>
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Intel Graphics Cards</strong></h1>
        <p style="font-size: 15px;">A third player has entered the GPU game. Built on Xe-HPG architecture, Intel graphics cards deliver fantastic performance in <br> modern triple-A games and support the latest technologies, including AI-powered upscaling, ray tracing, and more.</p>
        </div><hr>
