...
<!-----promo section---->
    ...
    <section class="brand-section">
        <div class="brand-content">
            <h1>HPE</h1>
            <p>Experience the power and reliability of HPE products, designed to support your business and technological needs. Our comprehensive range includes cutting-edge servers, robust storage solutions, advanced networking equipment, and innovative cloud services. HPE servers deliver exceptional performance and scalability, while our storage solutions ensure data integrity and accessibility.</p>
            <p class="short-text">
                Enhance your<span class="dots">...</span>
                <span class="more-text">
                    network infrastructure with HPE's high-speed switches and secure networking devices. Leverage our cloud and hybrid solutions to optimize your IT operations. Shop now to discover how HPE products can drive your business forward with unparalleled efficiency and reliability.
