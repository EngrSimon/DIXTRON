...
<div class="box-cat">
      ...
      <a href="{{route('RoutersAndMeshSystems')}}"><div class="box">Routers/Mesh Systems</a></div>
      <a href="{{route('NetworkSwitches')}}"><div class="box">Network Switches</div></a> 
      <a href="{{route('WirelessAccess')}}"><div class="box">Wireless Access</div></a> 
      </div> 
    </div><hr>
