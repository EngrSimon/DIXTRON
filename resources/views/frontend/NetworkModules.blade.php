...
<!----------------->
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Network Modules</strong></h1> <!---
        <p style="font-size: 15px;">Optimize your data center with our selection of servers and rack cabinets. Built for reliability and scalability, our servers <br> offer powerful performance for your business needs. Explore our range of rack cabinets designed to efficiently organize and <br>protect your equipment. From small businesses to enterprise-level solutions, we offer versatile options to suit your <br>requirements. Elevate your infrastructure with our reliable servers and rack cabinets.</p>-->
        </div> 

<div class="box-cat">
        <div class="box-container">
      <a href="Network Adapter Modules.html"><div class="box">Network Adapter Modules</a></div>
      <a href="Transceiver Modules.html"><div class="box">Transceiver Modules</a></div>
      </div> 
    </div><hr>
