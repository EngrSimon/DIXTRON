...
<br>
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Intel Motherboards</strong></h1>
        <p style="font-size: 15px;">Whether you're planning a brand-new build or just looking to upgrade your existing board to support the latest Intel CPUs, <br>our broad range of Intel motherboards offer up reliable performance for both day-to-day computing and intense high-end <br>gaming. You can find the best deals right here at Direct Computer</p>
        </div><hr>
