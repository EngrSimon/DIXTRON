...
<br>
    ...
    <div class="next-text">
        ...
        <div class="box-cat">
          ...
          <a href="{{route('NvidiaGraphicsCards')}}"><div class="box">Nvidia Graphics Cards</a></div>
          <a href="{{route('AMDGraphicsCards')}}"><div class="box">AMD Graphics Cards</div></a> 
          <a href="{{route('IntelGraphicsCards')}}"><div class="box">Intel Graphics Cards</div></a> 
          </div> 
        </div><hr>
