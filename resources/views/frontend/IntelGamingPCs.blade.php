...
<br>
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Intel Gaming PCs</strong></h1>
        <p style="font-size: 15px;">Step up your Gaming with our Intel Gaming PC collection. Expertly crafted, our Custom Built Intel Gaming PCs showcase <br> top-of-the-line components from Nvidia, Radeon and Intel, including the formidable Intel Core i3, i5, i7, and i9 <br> processors. Built on Intel motherboards including H510M, H610M, B660M, B660, B760M, B760, Z590, <br> Z690 and Z790, find a combination of DDR4 and DDR5 motherboards. All used from the top manufacturers like ASUS ROG Strix <br> and MSI Gaming, housed in sleek cases from Corsair and NZXT, and cooled with premium solutions from Cooler Master <br> and Noctua, our rigs are a testament to quality. Whether you're a streamer, content creator, or professional gamer, explore <br> a variety of options. Personalize your gaming setup effortlessly using our user-friendly configurator, supported by <br> flexible finance choices, a solid 3-year warranty, and free UK delivery. Each PC comes with a FREE copy of Windows 10 or 11 Pro.  </p>
        </div> 
<div class="box-cat">
        <div class="box-container">
      <a href="{{route('intelcorei3')}}"><div class="box">Intel Core i3 <br> PCs</a></div>
      <a href="{{route('intelCorei5')}}"><div class="box">Intel Core i5 <br> PCs</div></a> 
      <a href="{{route('intelCorei7')}}"><div class="box">Intel Core i7 <br> PCs</div></a>
      <a href="{{route('IntelCorei9')}}"><div class="box">Intel Core i9 <br> PCs</div></a>
      <a href="{{route('IntelCore12thGen')}}"><div class="box">Intel Core 12th <br> Gen Custom PCs</div></a>
      <a href="{{route('IntelCore13thgen')}}"><div class="box">Intel Core 13th <br> Gen Custom PCs</div></a>
      <a href="{{route('IntelCore14thGen')}}"><div class="box">Intel Core 14th <br> Gen Custom PCs</div></a>
      </div> 
    </div><hr>
<!----------->
