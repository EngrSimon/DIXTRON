...
<!----------------------->
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>IT Support Packages </strong></h1> 
        <p style="font-size: 15px;"> Explore our comprehensive IT support packages designed to keep your systems running smoothly. Choose from a range of <br>options tailored to your needs, from basic troubleshooting to advanced security solutions. Get reliable IT support when you <br> need it most.</p>
        </div> 

<div class="box-cat">
        <div class="box-container">
      <a href="Direct Protect IT Support.html"><div class="box">Direct Protect IT Support</a></div>
      </div> 
    </div><hr>
