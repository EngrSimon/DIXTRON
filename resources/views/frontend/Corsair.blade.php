...
<br>
    ...
    <div class="next-text">
      <h1 style="font-size: 40px;"> <strong>CORSAIR</strong></h1> 
      <p> Founded in 1994, Corsair has grown from pioneering the high-performance DRAM market to one of the worlds leading <br> providers of enthusiast-grade PC components and peripherals. Corsair's groundbreaking technology and <br> innovation can be found in their high-performance memory, ultra-efficient power supplies, PC cases, PC and CPU cooling <br>solutions, and solid-state storage devices. Under the Corsair Gaming brand, launched in 2014, they provide gaming keyboards, <br> mice, headsets and mouse mats to eSports professionals and anybody who is passionate about competitive PC gaming.</p>
      <p class="short-text">
          Corsair hardware is regularly featured in showcase<span class="dots">...</span>
          <span class="more-text">
              dream systems, and they have earned the adulation and respect of the press, <br>professional gamers and overclockers, high-end system integrators, and PC enthusiasts worldwide by delivering leading-edge <br>technology backed by renowned service and support.

              Corsair has developed a global operations infrastructure with extensive marketing <br>and distribution channel relationships, and their products are available through leading distributors and retailers in over sixty countries worldwide.
          </span>
      </p>
