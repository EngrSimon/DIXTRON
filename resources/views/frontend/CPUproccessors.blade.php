...
<!--------------------->
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>CPU Proccessors</strong></h1>
        <p style="font-size: 15px;">Whether you are building an entirely new PC or upgrading an existing one, our processors provide the performance boost <br>you are looking for. Whatever your budget, there is an <a href="AMD processor.html">AMD</a> or <a href="Intel processor.html">Intel</a> processor for you.</p>
        </div>

        
        <div class="box-cat">
            <div class="box-container">
          <a href="Intel processor.html"><div class="box">Intel Processors</a></div>
          <a href="AMD processor.html"><div class="box">AMD Processors</div></a> 
          </div> 
        </div><hr>
