...
<!-----promo section---->
    ...
    <section class="brand-section">
        <div class="brand-content">
            <h1>Samsung</h1>
            <p>Samsung Electronics was founded in 1969 and quickly became a major manufacturer in the Korean market. The digital age has brought revolutionary change and opportunity to global business and Samsung has responded with advanced technologies, competitive products and constant innovation.
            </p>
            <p class="short-text">
              With a quality range of SSDs and Monitors distributed<span class="dots">...</span>
                <span class="more-text">
                    by Dixtron Computers, Samsung has been recognised globally as an industry leader in technology and now ranked as a top 10 global brand.</span>
            </p>
