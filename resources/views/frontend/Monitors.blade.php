...
<!-------------->
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Monitors</strong></h1>
        <p style="font-size: 15px;">PC Monitors for Home Office, Gaming and Professional use. Top Brands like LG, Samsung & Dell feature all the most popular <br>sizes & specs including Full HD, 4K & Ultra Wide. Order online today for fast delivery.</p>
        </div> 

<div class="box-cat">
        <div class="box-container">
      <a href="home and office monitors.html"><div class="box">Home/Office Monitors</a></div>
      <a href="Gaming Monitors.html"><div class="box">Gaming Monintors</div></a> 
      <a href="Professional Monitors.html"><div class="box">Professional Monitors</div></a>
      <a href="Monitor Stands.html"><div class="box">Monitor Stands</div></a>
      <a href="Interactive Whiteboards.html"><div class="box">Interactive Whiteboards</div></a>
      </div> 
    </div><hr>
