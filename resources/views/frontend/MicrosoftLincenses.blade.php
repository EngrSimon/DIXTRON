...
<div class="box-cat">
      ...
      <a href="{{route('MicrosoftOfficeLincense')}}"><div class="box">Microsoft Office Lincense</a></div>
      <a href="{{route('MicrosoftWindowsLincense')}}"><div class="box">Microsoft Windows Lincense</div></a> 
      </div> 
    </div><hr>
