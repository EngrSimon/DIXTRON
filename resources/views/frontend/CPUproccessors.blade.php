...
<br>
    ...
    <div class="next-text">
        ...
        <p style="font-size: 15px;">Whether you are building an entirely new PC or upgrading an existing one, our processors provide the performance boost <br>you are looking for. Whatever your budget, there is an <a href="{{route('AMDprocessor')}}">AMD</a> or <a href="{{route('Intelprocessor')}}">Intel</a> processor for you.</p>
        </div>

        <div class="box-cat">
            <div class="box-container">
          <a href="{{route('Intelprocessor')}}"><div class="box">Intel Processors</a></div>
          <a href="{{route('AMDprocessor')}}"><div class="box">AMD Processors</div></a> 
          </div> 
        </div><hr>
