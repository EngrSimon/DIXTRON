...
<br>
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Motherboards</strong></h1>
        <p style="font-size: 15px;">Your motherboard is the most essential component inside your laptop and PC, especially when it comes to gaming. In <br>charge of connecting your processor, memory, storage, and every other component together, your motherboard allows <br>them all to communicate with each other and form a functional battle-station. A good motherboard is so important and <br>should be one of the main components you splash out on.</p>
        </div> 

        <div class="box-cat">
            <div class="box-container">
          <a href="{{route('Intelmotherboard')}}"><div class="box">Intel Motherboards</a></div>
          <a href="{{route('AMDmotherboard')}}"><div class="box">AMD Motherboards</div></a> 
          <a href="{{route('MotherboardBundles')}}"><div class="box">Motherboard Bundles</div></a>
        </div> <hr>
