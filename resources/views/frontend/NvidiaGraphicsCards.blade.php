...
<br>
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Nvidia Graphics Cards</strong></h1>
        <p style="font-size: 15px;">NVIDIA GeForce graphics cards are built for the ultimate PC gaming experience, delivering amazing performance, immersive <br> 3D gaming, and come loaded with an arsenal of game-changing technologies such as Real-time Ray Tracing, NVIDIA Reflex, <br>GPU Boost and DLSS 2.0. So, whether you’re dodging shells and levelling buildings in the latest Battlefield, or marvelling at the distant <br>beauty of Night City from the vast rolling desert of the Badlands in Cyberpunk 2077, we have the perfect range <br>of graphics cards for you.</p>
        </div><hr>
