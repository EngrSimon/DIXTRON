...
<!---------------->
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Desktop RAM</strong></h1>
        <p style="font-size: 15px;">If you're looking for new Desktop RAM, take a look at the wide range of memory we have available. With sizes and speeds <br>available to suit every need and budget, you can be sure to find RAM to improve your build and ensure applications run <br>quickly and smoothly.</p>
        </div><hr>
