...
<!-------------------->
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>AMD Ryzen 9 PCs</strong></h1>
        <p style="font-size: 15px;">Elevate your computing experience with our AMD Ryzen 9 PCs. Harness the power of AMD's flagship processors <br>for unparalleled performance and multitasking capabilities. Explore our range of desktops featuring Ryzen 9 processors, <br>designed to handle demanding tasks with ease. Whether you're a content creator, gamer, or professional, unlock new <br>possibilities with our AMD Ryzen 9 PCs.</p>
        </div> 
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-4">
      ...
      <div class="col">
        <div class="card h-100">
          <img src="assets/AMD Ryzen 9 PCs _ Direct Computers/1 (1).jpg" class="card-img-top" alt="#">
      ...
      <div class="col">
        <div class="card h-100">
          <img src="assets/AMD Ryzen 9 PCs _ Direct Computers/1 (2).jpg" class="card-img-top" alt="#">
          <div class="card-body text-center" style="background-color:rgb(253 239 228)">
			<!--
            <h5 class="card-title text-uppercase" style="color: #eb0905;">{{ $product->sale_label ?? 'SALE' }}</h5>
			-->
            ...
            <p style="font-size: 14px;">Genesis - Ryzen 7 5700X3D, 16GB DDR4, RTX 4060 Ti 16GB, 1TB SSD, AMD Gaming PC</p>
            <div class="mb-2">
              <i class="fa fa-star text-warning"></i>
              <i class="fa fa-star text-warning"></i>
              <i class="fa fa-star text-warning"></i>
      ...
      <div class="col">
        <div class="card h-100">
          <img src="assets/AMD Ryzen 9 PCs _ Direct Computers/1 (3).jpg" class="card-img-top" alt="#">
          <div class="card-body text-center" style="background-color:rgb(253 239 228)">
			<!--
            <h5 class="card-title text-uppercase" style="color: #eb0905;">{{ $product->sale_label ?? 'SALE' }}</h5>
			-->
            ...
            <p style="font-size: 14px;">Kraken - Ryzen 9 5900X, 32GB DDR4, RX 7900 XTX 24GB, 2TB SSD, 32" QHD 165Hz Monitor</p>
            <div class="mb-2">
              <i class="fa fa-star text-warning"></i>
              <i class="fa fa-star text-warning"></i>
              <i class="fa fa-star text-warning"></i>
      ...
      <div class="col">
        <div class="card h-100">
          <img src="assets/AMD Ryzen 9 PCs _ Direct Computers/1 (4).jpg" class="card-img-top" alt="#">
          <div class="card-body text-center" style="background-color:rgb(253 239 228)">
			<!--
            <h5 class="card-title text-uppercase" style="color: #eb0905;">{{ $product->sale_label ?? 'SALE' }}</h5>
			-->
            ...
            <p style="font-size: 14px;">Kraken - Ryzen 9 5900X, 32GB DDR4, RX 7900 XTX 24GB, 2TB SSD, AMD Gaming PC</p>
            <div class="mb-2">
              <i class="fa fa-star text-warning"></i>
              <i class="fa fa-star text-warning"></i>
              <i class="fa fa-star text-warning"></i>
