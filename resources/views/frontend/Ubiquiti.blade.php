...
<div class="box-cat">
      ...
      <a href="{{route('UbiquitiAirMAX')}}"><div class="box">Ubiquiti airMAX</a></div>
      <a href="{{route('UbiquitiAmpliFi')}}"><div class="box">Ubiquiti AmpliFi</div></a> 
      <a href="{{route('UbiquitiUniFiSwitches')}}"><div class="box">Ubiquiti UniFi Switches</a></div>
      <a href="{{route('UbiquitiUniFiRouters')}}"><div class="box">Ubiquiti UniFi Routers</div></a> 
      <a href="{{route('UbiquitiUniFiWireless')}}"><div class="box">Ubiquiti UniFi Wireless</div></a> 
      <a href="{{route('UbiquitiUniFiVideo')}}"><div class="box">Ubiquiti UniFi Video</a></div>
      <a href="{{route('UbiquitiAccessories')}}"><div class="box">Ubiquiti Accessories</div></a> 
      </div> 
    </div><hr>
