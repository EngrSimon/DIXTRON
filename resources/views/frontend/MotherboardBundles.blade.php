...
<br>
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Motherboards Bundles</strong></h1>
        <p style="font-size: 15px;">Our bundles come complete with everything you need to build a high-performance computer that can handle even the <br>most demanding applications. Whether you're a gamer, a home user, or a business professional, we have a bundle that will <br>meet your needs. With fast shipping, competitive pricing, and top-quality components, our motherboard bundles are the <br>perfect choice for anyone looking to upgrade their computing experience. Browse our selection today and find the bundle <br>that's right for you!</p>
        </div><hr>
