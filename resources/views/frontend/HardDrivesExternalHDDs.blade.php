...
<!--------------------->
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Hard Drives - External (HDDs)</strong></h1>
        <p style="font-size: 15px;">Portable External HDDs for On-the-Go Storage - Explore our selection of External Portable Hard Disk Drives (HDDs) <br> designed to provide convenient and reliable storage solutions wherever you go. Whether you need to back up important <br>files, carry your media library, or collaborate on projects away from your desk, our portable HDDs are the perfect choice. <br>With spacious storage capacities and robust data protection, these sleek and compact drives offer peace of mind and <br>versatility. Stay organized and connected, no matter where life takes you. Shop now to find the ideal external HDD for your <br>mobile storage needs.</p>
        </div><hr>
