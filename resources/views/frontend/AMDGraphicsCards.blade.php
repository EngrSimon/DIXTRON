...
<div class="promo-section">
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>AMD Graphics Cards</strong></h1>
        <p style="font-size: 15px;"> <strong><p style="font-size: 24px;"> Discover unbeatable value with the RX 7000 series and RX 6000 series</p></strong>Radeon™ series graphics cards offer cutting edge, innovative technologies including RDNA 3 delivering ray-tracing, AI <br> acceleration, and AMD Radiance Display Engine - perfect for gaming in 1080p, 1440p, or 4k at 60FPS or 144FPS.
            <br> <br>
            AMD Radeon GPUs are perfect for gaming, overclocking, streaming, and design with next-generation performance, visuals,<br> and efficiency.</p>
        </div><hr>
