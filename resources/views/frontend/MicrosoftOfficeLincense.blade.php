...
<br>
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Microsoft Office Lincense</strong></h1> 
        <p style="font-size: 15px;">Enhance productivity and collaboration with a Microsoft Office License. Access essential tools like Word, Excel, and <br>PowerPoint, tailored to streamline your work. Empower your team with cloud-based solutions for seamless communication <br> and document sharing. Explore licensing options to optimize your workflow with Microsoft Office.</p>
        </div> <hr>
