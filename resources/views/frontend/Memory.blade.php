...
<br> <br>
            We have a range of Desktop, Server and Laptop Memory.</p>
        </div>

        
        <div class="box-cat">
            <div class="box-container">
          <a href="{{route('DesktopRAM')}}"><div class="box">Desktop RAM</a></div>
          <a href="{{route('LaptopRAM')}}"><div class="box">Laptop RAM</div></a> 
          <a href="{{route('ServerRAM')}}"><div class="box">Server RAM</div></a> 
          </div> 
        </div><hr>
