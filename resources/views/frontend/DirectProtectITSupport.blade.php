...
<!----------------------------->
 ...
 <br>
    ...
    <div class="next-text">
        <h1 style="font-size: 40px;"> <strong>Direct Protect IT Support </strong></h1> 
        <p style="font-size: 15px;">Optimize your tech's performance with Direct Protect IT Support. Our comprehensive package ensures smooth PC and <br>laptop operation, offering software assistance and troubleshooting. Benefit from free phone support, remote assistance,<br> and diagnostics. Explore flexible pricing options starting at £9.99/month. Cancel anytime. Keep your devices running <br>smoothly with Direct Protect.</p>
        </div> <hr>
