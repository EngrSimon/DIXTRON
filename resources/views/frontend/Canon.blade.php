...
<br>
    ...
    <div class="next-text">
      <h1 style="font-size: 40px;"> <strong>CANON</strong></h1> 
      <p> <strong>Canon is your partner in digital print</strong> <br>
        Choosing Canon is choosing convenience. Select your media for all applications to drive more print jobs and boost your <br>business. Our extensive media assortment covers a broad range to maximise your productivity and printer uptime with approved media.</p>
    <p class="short-text">
        For home and office use,<span class="dots">...</span>
        <span class="more-text">
            or commercial printers: print with high quality Canon cut sheet papers. Beneﬁt from <br> eﬀortless printing with genuine toners, inks and supplies for your professional Canon printers.
        </span>
    </p>
